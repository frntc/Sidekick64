...
class SID_EXTERN SidTune
{
 ...
 public:  // ----------------------------------------------------------------
	...
	bool load( unsigned char* sidData, int sidLength, const bool separatorIsSlash = false);
 ...
 protected:  // -------------------------------------------------------------
    ...
    virtual LoadStatus PSID_fileSupport    ( unsigned char *dataBuf, int dataLen );
 ...
 private:  // ---------------------------------------------------------------
	...
	void getFromRaw( unsigned char* sidData, int sidLength );
