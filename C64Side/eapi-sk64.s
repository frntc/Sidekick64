...
;
; Modifications of the KungFuFlash-implementation to make it work with Sidekick64 (also simplified/faster communication) by Carsten Dachsbacher 
;
...
EAPICodeBase:
        ...
        .byte "Sidekick64 EAPI"         ; this signature used to be KungFuFlash, but looked kind of weird when used with Sidekick64 ;-)
...
ciNoRamError:
        ...
        ; send init command to SK64
        lda #CMD_EAPI_INIT
        send_byte

        ; check reply from SK64
        receive_byte
        bne SK64NotFound
...
returnOnly:                     ; C indicates error
        ...
        bcs returnCSet
        ldx #SK64_MFR_ID         ; manufacturer in X
        ldy #SK64_NUM_BANKS      ; number of banks in Y
